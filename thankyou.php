...
<header class="hero-section">
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="450">
        <div class="container">
            <div class="navbar-header"> <a class="navbar-brand p-0" href=""><img class="logo" alt="logo" src="img/zolo-weddings%20(white).png" width="239"><img class="logo-nav" alt="logo-nav" src="img/zoloweddings%20(red).png" width="239"></a> </div>
