...
<header class="hero-section">
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="450">
        <div class="container">
            <div class="navbar-header"> <a class="navbar-brand p-0" href="index.php"><img class="logo" alt="logo" src="img/zolo-weddings%20(white).png" width="239"><img class="logo-nav" alt="logo-nav" src="img/zoloweddings%20(red).png" width="239"></a> </div>
            ...
            <div class="col-md-12 center-block">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="m-0 w-800 img-text">Thank you for Contacting Us.</h1>
                        
                        <h2>One of our Wedding Expert will contact you shortly.</h2>



                        <div class="row m-b-20">
                            <div class="col-md-8 col-md-offset-2 col-xs-12 p-b-10 bg-p">
                               
                                <h2 class="w-600 text-center">For Urgent Requirements 
                                    <a href="tel:08882091091" class="call-inset-shadow">
                                   <br class="visible-xs visible-sm hidden-md m-b-10"> Call Now <i class="fa fa-phone"></i>
                                        088820-91091
                                    </a>
...
<!-- Google Code for Wedding Leads Conversion Page -->
...
var google_conversion_label = "w0bUCIPv92gQ8eaOowM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/878949233/?label=w0bUCIPv92gQ8eaOowM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
