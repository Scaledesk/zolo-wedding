...
<header class="hero-section">
    ...
    <nav class="navbar navbar-default" data-spy="affix" data-offset-top="450">
        <div class="container">
            <div class="navbar-header"> <a class="navbar-brand p-0" href=""><img class="logo" alt="logo" src="img/LOGO-01.svg" width="90"><img class="logo-nav" alt="logo-nav" src="img/LOGO-01.svg" width="90"></a> </div>
            ...
            <div class="col-md-12 center-block">
                <div class="row">
                    <div class="col-md-8 text-center">
                        ...
                        <!--<h2 class="f-24 ">A Commitment sincerer than your Vows.</h2>-->
...
<div class="container-fluid section-spacing wed-font w-section-spacing black-strip p-t-20 p-b-20" style="background-color: #fff;">
    <div class="row">
        ...
        <div class="col-md-3 border-right height text-center col-sm-6 p-l-30">
            ...
            <p  class="text-center">Dedicated Wedding Planners Under your Budget</p>
        </div>

        <div class="col-md-3 border-right height text-center col-sm-6">
            <img src="img/INSTALLMENT.png" alt="" class="img-circle" width="100">
            <p  class="text-center">Installment payments for service above INR 50 Thousand</p>
        </div>

        <div class="col-md-3 border-right height text-center col-sm-6">
            <img src="img/EXHAUSTIVE-LIST.png" alt="" class="img-circle" width="100">
            <p class="text-center">Exhaustive list of Venders</p>
        </div>
        ...
        <div class="col-md-3 border-right height text-center col-sm-6">
            ...
            <p class="text-center">Hassle free experience</p>
        </div>
                        ...
                        <div class="col-md-5 col-sm-6">
                            <div class="">
                                ...
                                <ul class="list-bullet p-l-10">
                                    ...
                                    <li>Talk on heavy-duty topics like money, sex, and kids</li>
...
<div class="container-fluid p-b-10 p-t-10  section-spacing text-center w-section-spacing " style="background-color: #f9f9f9;">
    <!--<h2 class="text-center">GIVE IT A TRY! </h2>-->

    <div class="row">
        <h2 class="w-800">Get In Touch & Feel The Zolo Experience</h2>
        <div class="col-md-4 p-10-74">
            <h3 class="m-t-0 p-10" style="border: 1px solid #eee;"><i class="fa fa-phone-square" aria-hidden="true"></i>
                &nbsp;+91 88820-91091</h3>
            <p class="f-20">Talk To Our Wedding Expert</p>
        </div>
